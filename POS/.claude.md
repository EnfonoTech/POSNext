# Claude Code Rules for FatehPOS

This file contains project-specific rules and conventions for Claude Code when working on the FatehPOS application.
...
*Project: FatehPOS - Modern POS System for ERPNext*
